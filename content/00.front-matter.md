...
+ **{{author.name}}**
  ...
  {%- endif %}
  {%- if author.mastodon is defined and author.mastodon is not none if author.mastodonserver is defined and author.mastodonserver is not none %}
  · ![Mastodon icon](images/mastodon.svg){.inline_icon}
  [@{{author.mastodon}}]({{author.mastodonserver}}/@{{author.mastodon}})
  {%- endif %}
  {%- if has_ids %}
    <br>
  {%- endif %}
